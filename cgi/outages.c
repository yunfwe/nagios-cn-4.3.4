...
*/
	...
	printf("<TR>\n");
	printf("<TH CLASS='data'>严重程度</TH><TH CLASS='data'>主机</TH><TH CLASS='data'>状态</TH><TH CLASS='data'>笔记</TH><TH CLASS='data'>状态持续时长</TH><TH CLASS='data'># 主机影响</TH><TH CLASS='data'># 服务影响</TH><TH CLASS='data'>行动</TH>\n");
	printf("</TR>\n");
	...
	if(total_entries == 0)
		printf("<DIV CLASS='itemTotalsTitle'>%d个阻塞故障显示</DIV>\n", total_entries);
