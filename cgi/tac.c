...
void display_tac_overview(void) {
	...
	display_info_table("监控概述", TRUE, &current_authdata);
	...
	printf("<table class='mytab' lay-even lay-skin='nob' >");
	printf("<thead>\n");
	printf("<tr>\n");
	// printf("<td class='perfTitle'>&nbsp;<a href='%s?type=%d' class='perfTitle'>Monitoring Performance</a></td>\n", EXTINFO_CGI, DISPLAY_PERFORMANCE);
	printf("<th><a href='%s?type=%d' style='font-size:14px;font-weight: bold;'>性能监测</a></th>\n", EXTINFO_CGI, DISPLAY_PERFORMANCE);
	printf("<th></th>\n");
	printf("</tr>\n");
	printf("</thead>\n");
	...
	printf("</tr>\n");
	printf("<tr>\n");
	printf("<td align=left valign=center class='perfItem'><a href='%s?type=%d' class='perfItem'>服务检查反应时间：</a></td>", EXTINFO_CGI, DISPLAY_PERFORMANCE);
	...
	printf("</tr>\n");
	printf("<tr>\n");
	printf("<td align=left valign=center class='perfItem'><a href='%s?type=%d' class='perfItem'>主机检查反应时间：</a></td>", EXTINFO_CGI, DISPLAY_PERFORMANCE);
	...
	printf("</tr>\n");
	printf("<tr>\n");
	printf("<td align=left valign=center class='perfItem'><a href='%s?host=all&serviceprops=%d' class='perfItem'>主动的[主机/服务]检查：</a></td>", STATUS_CGI, SERVICE_ACTIVE_CHECK);
	...
	printf("</tr>\n");
	printf("<tr>\n");
	printf("<td align=left valign=center class='perfItem'><a href='%s?host=all&serviceprops=%d' class='perfItem'>被动的[主机/服务]检查：</a></td>", STATUS_CGI, SERVICE_PASSIVE_CHECK);
	...
	printf("<table class='mytab' lay-even lay-skin='nob'  style='width:180px;'>");

	printf("<tr><td colspan=1 height=20 class='outageTitle'>&nbsp;网络故障</td></tr>\n");

	printf("<tr>\n");
	printf("<td width=125><a href='%s' class='astyle' >", OUTAGES_CGI);
	if(is_authorized_for_all_hosts(&current_authdata) == FALSE)
		printf("N/A");
	else
		printf("故障次数：%d", total_blocking_outages);
	printf("</a></td>\n");
	printf("</tr>\n");
	...
	*/
	...
	// printf("<table border=0 cellspacing=0 cellpadding=0>\n");
	printf("<table class='mytab' lay-even lay-skin='nob'  style='width:280px;'>");
	printf("<tr>\n");
	// printf("<td>\n");

	// printf("<table border=0 cellspacing=4 cellpadding=0>\n");
	// printf("<tr>\n");
	printf("<td colspan='2' class='healthTitle'>&nbsp;网络健康状态</td>\n");
	//printf("<td class='healthTitle'></td>\n");
	printf("</tr>\n");
	...
	// printf("<table border=0 cellspacing=4 cellpadding=0>\n");
	// printf("<tr>\n");
	printf("<td align=left valign=center>主机健康状态：</td>");
	printf("<td valign=top width=100 ><img src='%s%s' border=0 width=%d height=20 alt='%2.1f%% Health' title='%2.1f%% Health'></td>\n", url_images_path, host_health_image, (percent_host_health < 5.0) ? 5 : (int)percent_host_health, percent_host_health, percent_host_health);
	printf("</tr>\n");
	printf("<tr>\n");
	printf("<td align=left valign=center>服务健康状态：</td>");
	...
	printf("<table class='mytab' lay-even lay-skin='nob'  style='width:650px;'>");

	printf("<tr><td colspan=4 height=20 class='hostTitle'>&nbsp;所有主机</td></tr>\n");

	printf("<tr>\n");
	printf("<td  width=140><a href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d' >宕机状态：%d</a></td>\n", STATUS_CGI, SD_HOST_DOWN, hosts_down);
	printf("<td  width=140><a href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d' >不可达状态：%d</a></td>\n", STATUS_CGI, SD_HOST_UNREACHABLE, hosts_unreachable);
	printf("<td  width=140><a href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d' >正常状态：%d</a></td>\n", STATUS_CGI, SD_HOST_UP, hosts_up);
	printf("<td  width=140><a href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d' >待定状态：%d</a></td>\n", STATUS_CGI, HOST_PENDING, hosts_pending);
	printf("</tr>\n");
	...
	if(hosts_down_unacknowledged > 0)
		printf("<tr><td class='hostImportantProblem my-bg-orange'><a style='color:black;' href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d&hostprops=%d'>未处理的故障：%d</a></td></tr>\n", STATUS_CGI, SD_HOST_DOWN, HOST_NO_SCHEDULED_DOWNTIME | HOST_STATE_UNACKNOWLEDGED | HOST_CHECKS_ENABLED, hosts_down_unacknowledged);

	if(hosts_down_scheduled > 0)
		printf("<tr><td  class='hostUnimportantProblem my-bg-green'><a style='color:black;' href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d&hostprops=%d'>计划中的：%d</a></td></tr>\n", STATUS_CGI, SD_HOST_DOWN, HOST_SCHEDULED_DOWNTIME, hosts_down_scheduled);

	if(hosts_down_acknowledged > 0)
		printf("<tr><td  class='hostUnimportantProblem'><a style='color:black;' href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d&hostprops=%d'>公知的：%d</a></td></tr>\n", STATUS_CGI, SD_HOST_DOWN, HOST_STATE_ACKNOWLEDGED, hosts_down_acknowledged);

	if(hosts_down_disabled > 0)
		printf("<tr><td  class='hostUnimportantProblem mygray'><a style='color:black;' href='%s?hostgroup=all&style=hostdetail&hoststatustypes=%d&hostprops=%d'>禁用的：%d</a></td></tr>\n", STATUS_CGI, SD_HOST_DOWN, HOST_CHECKS_DISABLED, hosts_down_disabled);
	...
	*/
	...
	printf("<table class='mytab' lay-even lay-skin='nob'  style='width:800px;'>");

	printf("<tr><td colspan=5 height=20 class='serviceTitle'>&nbsp;所有服务</td></tr>\n");

	printf("<tr>\n");
	printf("<td><a href='%s?host=all&style=detail&servicestatustypes=%d' >严重级别：%d</a></td>\n", STATUS_CGI, SERVICE_CRITICAL, services_critical);
	printf("<td><a href='%s?host=all&style=detail&servicestatustypes=%d' >警告级别：%d</a></td>\n", STATUS_CGI, SERVICE_WARNING, services_warning);
	printf("<td><a href='%s?host=all&style=detail&servicestatustypes=%d' >未知状态：%d</a></td>\n", STATUS_CGI, SERVICE_UNKNOWN, services_unknown);
	printf("<td><a href='%s?host=all&style=detail&servicestatustypes=%d' >正常状态：%d</a></td>\n", STATUS_CGI, SERVICE_OK, services_ok);
	printf("<td><a href='%s?host=all&style=detail&servicestatustypes=%d' >待定状态：%d</a></td>\n", STATUS_CGI, SERVICE_PENDING, services_pending);
	printf("</tr>\n");
	...
	if(services_critical_unacknowledged > 0)
		printf("<tr><td  class='serviceImportantProblem my-bg-orange'><a style='color:black;' href='%s?host=all&type=detail&servicestatustypes=%d&hoststatustypes=%d&serviceprops=%d'>未处理的故障：%d</a></td></tr>\n", STATUS_CGI, SERVICE_CRITICAL, SD_HOST_UP | HOST_PENDING, SERVICE_NO_SCHEDULED_DOWNTIME | SERVICE_STATE_UNACKNOWLEDGED | SERVICE_CHECKS_ENABLED, services_critical_unacknowledged);

	if(services_critical_host_problem > 0)
		printf("<tr><td  class='serviceUnimportantProblem my-bg-red'><a style='color:black;' href='%s?host=all&type=detail&servicestatustypes=%d&hoststatustypes=%d'>有问题的主机：%d</a></td></tr>\n", STATUS_CGI, SERVICE_CRITICAL, SD_HOST_DOWN | SD_HOST_UNREACHABLE, services_critical_host_problem);

	if(services_critical_scheduled > 0)
		printf("<tr><td  class='serviceUnimportantProblem my-bg-green'><a style='color:black;' href='%s?host=all&type=detail&servicestatustypes=%d&serviceprops=%d'>计划中的：%d</a></td></tr>\n", STATUS_CGI, SERVICE_CRITICAL, SERVICE_SCHEDULED_DOWNTIME, services_critical_scheduled);

	if(services_critical_acknowledged > 0)
		printf("<tr><td class='serviceUnimportantProblem'><a style='color:black;' href='%s?host=all&type=detail&servicestatustypes=%d&serviceprops=%d'>公知的：%d</a></td></tr>\n", STATUS_CGI, SERVICE_CRITICAL, SERVICE_STATE_ACKNOWLEDGED, services_critical_acknowledged);

	if(services_critical_disabled > 0)
		printf("<tr><td class='serviceUnimportantProblem mygray'><a style='color:black;' href='%s?host=all&type=detail&servicestatustypes=%d&serviceprops=%d'>禁用的：%d</a></td></tr>\n", STATUS_CGI, SERVICE_CRITICAL, SERVICE_CHECKS_DISABLED, services_critical_disabled);
	...
	printf("<table class='mytab' lay-even lay-skin='nob'  style='width:1000px;'>");

	printf("<tr><td colspan=5 height=20 class='featureTitle'>&nbsp;监控功能</td></tr>\n");

	printf("<tr>\n");
	printf("<td class='featureHeader' >波动监测</td>\n");
	printf("<td class='featureHeader' >通知</td>\n");
	printf("<td class='featureHeader'>事件处理</td>\n");
	printf("<td class='featureHeader' >主动检测</td>\n");
	printf("<td class='featureHeader' >被动检测</td>\n");
	printf("</tr>\n");

	printf("<tr class='mypadding'>\n");

	printf("<td valign=top >\n");
	printf("<table border=0 width=135 cellspacing=0 cellpadding=0>\n");
	printf("<tr>\n");
	printf("<td valign=top><a href='%s?cmd_typ=%d'><img src='%s%s' border=0 alt='波动检测%s' title='波动检测%s'></a></td>\n", COMMAND_CGI, (enable_flap_detection == TRUE) ? CMD_DISABLE_FLAP_DETECTION : CMD_ENABLE_FLAP_DETECTION, url_images_path, (enable_flap_detection == TRUE) ? TAC_ENABLED_ICON : TAC_DISABLED_ICON, (enable_flap_detection == TRUE) ? "启用" : "禁用", (enable_flap_detection == TRUE) ? "启用" : "禁用");
	// printf("<Td width=10>&nbsp;</td>\n");
	if(enable_flap_detection == TRUE) {
		...
		if(flap_disabled_services > 0)
			printf("<tr><td width=100%% class='featureItemDisabledServiceFlapDetection'><a href='%s?host=all&type=detail&serviceprops=%d'>%d 个服务已禁用</a></td></tr>\n", STATUS_CGI, SERVICE_FLAP_DETECTION_DISABLED, flap_disabled_services);
		else
			printf("<tr><td width=100%% class='featureItemEnabledServiceFlapDetection'>所有服务启用</td></tr>\n");

		if(flapping_services > 0)
			printf("<tr><td width=100%% class='featureItemServicesFlapping'><a href='%s?host=all&type=detail&serviceprops=%d'>%d 个服务状态波动</a></td></tr>\n", STATUS_CGI, SERVICE_IS_FLAPPING, flapping_services);
		else
			printf("<tr><td width=100%% class='featureItemServicesNotFlapping'>没有服务存在状态波动</td></tr>\n");

		if(flap_disabled_hosts > 0)
			printf("<tr><td width=100%% class='featureItemDisabledHostFlapDetection'><a href='%s?hostgroup=all&style=hostdetail&hostprops=%d'>%d 个主机已禁用</a></td></tr>\n", STATUS_CGI, HOST_FLAP_DETECTION_DISABLED, flap_disabled_hosts);
		else
			printf("<tr><td width=100%% class='featureItemEnabledHostFlapDetection'>所有主机启用</td></tr>\n");

		if(flapping_hosts > 0)
			printf("<tr><td width=100%% class='featureItemHostsFlapping'><a href='%s?hostgroup=all&style=hostdetail&hostprops=%d'>%d 个主机状态波动</a></td></tr>\n", STATUS_CGI, HOST_IS_FLAPPING, flapping_hosts);
		else
			printf("<tr><td width=100%% class='featureItemHostsNotFlapping'>没有主机存在状态波动</td></tr>\n");
	...
	if(enable_notifications == TRUE) {
		...
		if(notification_disabled_services > 0)
			printf("<tr><td width=100%% class='featureItemDisabledServiceNotifications'><a href='%s?host=all&type=detail&serviceprops=%d'>%d 个服务已禁用</a></td></tr>\n", STATUS_CGI, SERVICE_NOTIFICATIONS_DISABLED, notification_disabled_services);
		else
			printf("<tr><td width=100%% class='featureItemEnabledServiceNotifications'>所有服务启用</td></tr>\n");

		if(notification_disabled_hosts > 0)
			printf("<tr><td width=100%% class='featureItemDisabledHostNotifications'><a href='%s?hostgroup=all&style=hostdetail&hostprops=%d'>%d 个主机已禁用</a></td></tr>\n", STATUS_CGI, HOST_NOTIFICATIONS_DISABLED, notification_disabled_hosts);
		else
	...
	if(enable_event_handlers == TRUE) {
		...
		if(event_handler_disabled_services > 0)
			printf("<tr><td width=100%% class='featureItemDisabledServiceHandlers'><a href='%s?host=all&type=detail&serviceprops=%d'>%d 个服务已禁用</a></td></tr>\n", STATUS_CGI, SERVICE_EVENT_HANDLER_DISABLED, event_handler_disabled_services);
		else
			printf("<tr><td width=100%% class='featureItemEnabledServiceHandlers'>所有服务启用</td></tr>\n");

		if(event_handler_disabled_hosts > 0)
			printf("<tr><td width=100%% class='featureItemDisabledHostHandlers'><a href='%s?hostgroup=all&style=hostdetail&hostprops=%d'>%d 个主机已禁用</a></td></tr>\n", STATUS_CGI, HOST_EVENT_HANDLER_DISABLED, event_handler_disabled_hosts);
		else
	...
	if(execute_service_checks == TRUE) {
		...
		if(active_checks_disabled_services > 0)
			printf("<tr><td width=100%% class='featureItemDisabledActiveServiceChecks'><a href='%s?host=all&type=detail&serviceprops=%d'>%d 个服务已禁用</a></td></tr>\n", STATUS_CGI, SERVICE_CHECKS_DISABLED, active_checks_disabled_services);
		else
			printf("<tr><td width=100%% class='featureItemEnabledActiveServiceChecks'>所有服务启用</td></tr>\n");

		if(active_checks_disabled_hosts > 0)
			printf("<tr><td width=100%% class='featureItemDisabledActiveHostChecks'><a href='%s?hostgroup=all&style=hostdetail&hostprops=%d'>%d 个主机已禁用</a></td></tr>\n", STATUS_CGI, HOST_CHECKS_DISABLED, active_checks_disabled_hosts);
		else
	...
	if(accept_passive_service_checks == TRUE) {
		...
		if(passive_checks_disabled_services > 0)
			printf("<tr><td width=100%% class='featureItemDisabledPassiveServiceChecks'><a href='%s?host=all&type=detail&serviceprops=%d'>%d 个服务已禁用</a></td></tr>\n", STATUS_CGI, SERVICE_PASSIVE_CHECKS_DISABLED, passive_checks_disabled_services);
		else
			printf("<tr><td width=100%% class='featureItemEnabledPassiveServiceChecks'>所有服务启用</td></tr>\n");

		if(passive_checks_disabled_hosts > 0)
			printf("<tr><td width=100%% class='featureItemDisabledPassiveHostChecks'><a href='%s?hostgroup=all&style=hostdetail&hostprops=%d'>%d 个主机已禁用</a></td></tr>\n", STATUS_CGI, HOST_PASSIVE_CHECKS_DISABLED, passive_checks_disabled_hosts);
		else
